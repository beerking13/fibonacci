...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.fibonacci.autotvin_f0.dat"
         "c.fibonacci.autotvin_f1.dat"
         "c.fibonacci.autotvin_f2.dat"
         "c.fibonacci.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.fibonacci.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
