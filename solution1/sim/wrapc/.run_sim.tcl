...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "fibonacci.autotvin.dat"
	set constFileTvOut       "fibonacci.autotvout.dat"
	set constFileHdlTvIn     "fibonacci.autohdltvin.dat"
	set constFileHdlTvOut    "fibonacci.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
