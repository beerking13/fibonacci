...
if {[file isfile fibonacci.autotvin.dat]} {
	file delete -force fibonacci.autotvin.dat
}

if {[file isfile fibonacci.autotvout.dat]} {
	file delete -force fibonacci.autotvout.dat
}
